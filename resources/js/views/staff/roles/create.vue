...
const validationSchema = Yup.object().shape({
  ...
  users: Yup.number().required().nullable().label("Users Permission").typeError('Invalid value'),
  staff: Yup.number().required().nullable().label("Staff Permission").typeError('Invalid value'),
  account: Yup.number().required().nullable().label("Account Permission").typeError('Invalid value'),
  fundUser: Yup.number().required().nullable().label("Fund User Permission").typeError('Invalid value'),
  signal: Yup.number().required().nullable().label("Signal Permission").typeError('Invalid value'),
});
