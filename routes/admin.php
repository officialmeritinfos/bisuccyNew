...
/*=======================DASHBOARD CONTROLLER ROUTES==============*/
    ...
    //Middleware - accessAccount - restricts to only roles that can manipulate system finances
    Route::middleware('accessAccount')->group(function () {
    ...
    //Middleware - accessSignal - restricts to only roles allowed to manipulate signals
    Route::middleware(['accessSignal'])->group(function (){
        ...
        Route::post('signal-payments/approve', [SignalEnrollmentPayments::class, 'approveSignalPayment'])
            ->name('approveSignalPayment')->middleware('accessAccount');//approve signal payment
    });
    ...
    //Middleware - accessStaff - restricts to only roles allowed to manipulate staff
    Route::middleware(['accessStaff'])->group(function () {
    ...
    //Middleware - accessUser - restricts to only roles that can manipulate user account
    ...
    //Middleware - accessUser - restricts to only roles that can manipulate user accounts
    Route::middleware('accessUser')->group(function () {
    ...
    //Middleware - canFund - restricts to only roles with permission to fund user account
    Route::middleware(['accessUser', 'canFund'])->group(function (){
    ...
    //Middleware - accessUser - restricts only to roles that can operate user account
    Route::middleware('accessUser')->group(function (){
    ...
    Route::post('get-gas-fee', [UserWallets::class, 'calculateGasFees'])
        ->name('getGasFee');//estimate fee for transferring from account deprecated but left for legacy purpose
    ...
    Route::middleware('accessAccount')->group(function () {
        ...
        Route::get('withdrawals/user/all/{user}/{index?}', [Withdrawals::class, 'getWithdrawalByUser'])
            ->name('getWithdrawalsByUser')->middleware('accessUser');//fetch all withdrawals from a user
    });
